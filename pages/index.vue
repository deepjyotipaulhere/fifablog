            ...
            <div class="header__content row">
                ...
                <nav class="header__nav-wrap">
                    ...
                    <ul class="header__nav">
                        ...
                        <li><nuxt-link :to="'/blog/create'" title="">Write</nuxt-link></li>
                        <li><a href="about.html" title="">About</a></li>
                        <li v-if="$cookies.get('auth')==null">
                          <nuxt-link :to="'/register'" title="">Sign In</nuxt-link>
                        </li>
                        <li class="has-children" v-else>
                            <a href="#0" title="">{{$cookies.get('name')}}</a>
                            <ul class="sub-menu">
                              <li><a href="#!" title="" @click="logout">Log Out</a></li>
                            </ul>
                        </li>
                    </ul> <!-- end header__nav -->
    ...
    <section class="s-content">
        ...
        <div class="row masonry-wrap">
            <div class="masonry">
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up" v-for="(x,i) in posts" :key="i">
                        
                    <div class="entry__thumb">
                        <nuxt-link :to="'/blog/'+x.id" class="entry__thumb-link">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <div class="entry__date">
                                <nuxt-link :to="'/blog/'+x.id">December 15, 2017</nuxt-link>
                            </div>
                            <h1 class="entry__title"><nuxt-link :to="'/blog/'+x.id">{{x.title}}</nuxt-link></h1>
...
export default {
  ...
  methods:{
    load(){
      this.$axios.get(process.env.baseURL+"/getblogs/0").then(response=>{
